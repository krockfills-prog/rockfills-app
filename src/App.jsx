...
function buildPrintHtml(rows, notice, boysM, girlsM, holidaysSet, currentYM) {
  ...
  return `<!DOCTYPE html><html lang="ja"><head><meta charset="UTF-8"><style>*{-webkit-print-color-adjust:exact;print-color-adjust:exact;box-sizing:border-box}body{font-family:'Noto Sans JP','Helvetica Neue',Arial,sans-serif;font-size:10pt;color:#111;margin:0;padding:10mm 12mm}@page{size:A4 portrait;margin:0}table{width:100%;border-collapse:collapse}</style></head><body>
